...
-- AddForeignKey
ALTER TABLE "sub_tasks" ADD CONSTRAINT "sub_tasks_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "time_entries" ADD CONSTRAINT "time_entries_subTaskId_fkey" FOREIGN KEY ("subTaskId") REFERENCES "sub_tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE;
